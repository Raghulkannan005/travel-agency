  ...
  return (
    <footer className="bg-gray-800 text-white pt-8 pb-6">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h2 className="text-xl font-bold mb-4">
              <span className="text-travel-yellow">Travel</span>Agency
            </h2>
            <p className="text-gray-400 mb-4">Discover the world with our premium travel packages and expert guides.</p>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 text-travel-teal">Quick Links</h3>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 text-travel-orange">Popular Destinations</h3>
            <ul className="space-y-2">
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 text-travel-yellow">Contact Us</h3>
        ...
        <div className="mt-8 pt-6 border-t border-gray-700 text-center md:flex md:justify-between">
